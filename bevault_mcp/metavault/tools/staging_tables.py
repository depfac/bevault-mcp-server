...
from bevault_mcp.metavault.models import CreateStagingTableRequest, StagingTableColumn
from bevault_mcp.metavault.models.api.entities.mapping import (
    HubMapping,
    LinkMapping,
    SatelliteMapping,
)
from bevault_mcp.metavault.models.api.responses.mappings import (
    ColumnMapping,
    FormattedMapping,
)
from bevault_mcp.metavault.models.requests.staging_table import (
    BaseTypeRequest,
...
def get_staging_table(
    ...
    try:
        ...
        for mapping_data in mappings_response.mappings_list:
            ...
            if mapping_type == "Hub":
                ...
                if mapping.linkId not in link_entities:
                    try:
                        link_entity = client.model.get_link(project_id, mapping.linkId)
        ...
        result = {
            ...
            "mappings": [
                m.model_dump(mode="json", exclude_none=True) for m in formatted_mappings
            ],
        }
