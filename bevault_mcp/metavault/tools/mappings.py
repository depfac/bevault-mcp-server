...
from bevault_mcp.metavault.client import MetavaultClient
from bevault_mcp.shared.utils import is_guid
...
def _get_base_url(client: MetavaultClient) -> str:
