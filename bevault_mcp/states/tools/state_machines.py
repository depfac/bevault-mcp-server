...
def get_state_machine(stateMachineName: str) -> dict:
    ...
    try:
        ...
        logger.info("get_state_machine: stateMachineName=%s", params.stateMachineName)
        state_machine = client.state_machines.get_state_machine(params.stateMachineName)
...
def delete_state_machine(stateMachineName: str) -> dict:
    ...
    try:
        ...
        return {"message": f"State machine '{stateMachineName}' deleted successfully"}
    except Exception:  # noqa: BLE001
